...
export default function Moto2ArticlesPage() {
  ...
  // Filter only Moto2 articles
  const categoryArticles = allArticles.filter(
    (article: any) => article.category?.toLowerCase() === 'moto2'
  )
    ...
    <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-12">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-6xl font-bebas font-black uppercase tracking-tight">Moto2</h1>
      ...
      {categoryArticles.length > 0 ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-2xl font-bebas uppercase mb-2">Belum Ada Artikel Moto2</h3>
