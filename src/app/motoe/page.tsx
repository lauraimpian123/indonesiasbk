...
export default function MotoEArticlesPage() {
  ...
  // Filter only MotoE articles
  const categoryArticles = allArticles.filter(
    (article: any) => article.category?.toLowerCase() === 'motoe'
  )
    ...
    <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-12">
        <div className="flex items-center gap-4 mb-4">
          <div className="w-20 h-20 bg-[#00e5ff] rounded-xl flex items-center justify-center text-4xl">
            ⚡
          </div>
          <div>
            <h1 className="text-6xl font-bebas font-black uppercase tracking-tight">MotoE</h1>
      ...
      {categoryArticles.length > 0 ? (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden bg-black/40">
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1 bg-[#00e5ff] rounded-full text-xs font-bebas uppercase tracking-wide">
                    {article.category || 'MotoE'}
                  </span>
                </div>
              </div>
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-2xl font-bebas uppercase mb-2">Belum Ada Artikel MotoE</h3>
