...
import { helmetReviews, brandLists } from '@/data/reviews';
...
export default function HelmetReviewPage() {
  ...
  const filteredReviews = selectedBrand
    ? helmetReviews.filter((review) => review.brand === selectedBrand)
    : helmetReviews;
  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <div className="border-b border-white/10 bg-black/80">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-400">
            ...
            <span>/</span>
            <span className="text-white">Review Helmet</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 border-b border-white/10">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mb-6">
            Review mendalam helmet sport dan racing: dari premium AGV Pista hingga entry-level lokal. 
            Fokus pada safety certification, comfort, ventilasi, dan value for money.
          </p>
      ...
      {/* Safety Info */}
      <section className="py-12 border-t border-white/10 bg-gradient-to-b from-black to-[#ff1744]/10">
        <div className="container mx-auto px-4">
      ...
      <section className="py-12 border-t border-white/10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bebas text-white mb-4 uppercase">
            Butuh Rekomendasi Helmet?
          </h2>
          <p className="text-gray-400 mb-6">
            Bingung pilih helmet? Kontak kami untuk konsultasi gratis sesuai budget dan kebutuhan kamu.
          </p>
          <Link
            href="/contact"
