...
import { gearReviews, brandLists } from '@/data/reviews';
...
export default function GearReviewPage() {
  ...
  const filteredReviews = selectedBrand
    ? gearReviews.filter((review) => review.brand === selectedBrand)
    : gearReviews;
      ...
      <div className="border-b border-white/10 bg-black/80">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-400">
            ...
            <span>/</span>
            <span className="text-white">Review Gear</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 border-b border-white/10">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mb-6">
            Ulasan lengkap riding gear: racing suit, boots, gloves, dan body armor. 
            Fokus pada proteksi, comfort, dan value for money untuk keamanan maksimal di jalan dan sirkuit.
          </p>
      ...
      <section className="py-12 border-t border-white/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-6">
            Riding gear yang tepat bisa menyelamatkan nyawa. Investasi terbaik untuk keamanan kamu.
          </p>
          <Link
            href="/contact"
